...
if(isset($_POST["Rquestao13"])){
	if ($_POST["Rquestao13"] == "D13"){
	$_SESSION["pontos"]+= 1;
}
}
...
<head>
  ...
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.9/umd/popper.min.js"></script>
		...
		<div class="col-md-4">
             ...
             <div class="form-group">
				...
				<select name="questao1" class="form-control">
                 ...
                 <option value="E1">(E)	While, Case, IF</option>
                  ...
                  <div class="form-group">
					<label for="pergunta14">Questão 14<br>
           ...
           qual comando correto para recuperar um valor de input com name txtvalor enviados de acordo com a imagem abaixo.
             <br>
					 ...
					 <img src="imagens/pergunta14.png" class="img-responsive img">      
			...
			<fieldset id="Questao"><legend>Respostas:</legend>
			  ...
			  <input type="radio" name="Rquestao14" id="Ra14" checked="" value="A14" /> <label for="Ra14">A)	0</label> <br>
			 <input type="radio" name="Rquestao14" id="Rb14" value="B14"/> <label for="Rb14">B)	1</label><br>
             <input type="radio" name="Rquestao14" id="Rc14" value="C14"/> <label for="Rc14">C)	2</label><br>
             <input type="radio" name="Rquestao14" id="Rd14" value="D14"/> <label for="Rd14">D)	7</label><br>
			 <input type="radio" name="Rquestao14" id="Re14" value="E14"/> <label for="Re14">E)	8</label><br>
