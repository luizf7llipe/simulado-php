...
if(isset($_POST["Rquestao14"])){
	if ($_POST["Rquestao14"] == "A14"){
	$_SESSION["pontos"]+= 1;
}
}
...
<body>
	...
	<div class="row">
		...
		<div class="col-md-4">
			 ...
			 <h4>Total de acerto: <?php echo $_SESSION["pontos"]; ?> </h4>
                 ...
                 <option value="E1">(E)	While, Case, IF</option>
                  ...
                  <br>
					...
					<div class="col-md-6 col-xs-6">
						<a href="index.html" class="btn btn-danger" name="Voltar" value="">Voltar</a>
					</div>
				</div>
